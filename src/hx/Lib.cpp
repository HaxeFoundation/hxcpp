...
#elif (defined (IPHONE) || defined(EMSCRIPTEN) || defined(STATIC_LINK) || defined(TVOS) ) && !defined(HXCPP_DLL_IMPORT) && (!defined(HXCPP_DLL_EXPORT) || defined(HXCPP_SCRIPTABLE) )
...
Module hxLoadLibrary(String inLib)
{
   ...
   #if defined(HXCPP_RTLD_LAZY) || defined(IPHONE) || defined(EMSCRIPTEN) || defined(STATIC_LINK) || defined(TVOS)
   flags |= RTLD_LAZY;
   #else
   flags |= RTLD_NOW;
   #endif
...
#if (defined(IPHONE) || defined(EMSCRIPTEN) || defined(STATIC_LINK) || defined(TVOS) ) && !defined(HXCPP_DLL_IMPORT) && (!defined(HXCPP_DLL_EXPORT) || defined(HXCPP_SCRIPTABLE) )
...
#if !defined(ANDROID) && !defined(HX_WINRT) && !defined(IPHONE) && !defined(EMSCRIPTEN) && !defined(STATIC_LINK) && !defined(TVOS)
