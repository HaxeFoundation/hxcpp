...
inline cpp::Int64 _hx_int64_pre_increment(cpp::Int64 a) {
   return ++a;
}
inline cpp::Int64 _hx_int64_post_increment(cpp::Int64 a) {
   return a++;
}
inline cpp::Int64 _hx_int64_pre_decrement(cpp::Int64 a) {
   return --a;
}
inline cpp::Int64 _hx_int64_post_decrement(cpp::Int64 a) {
   return a--;
}
